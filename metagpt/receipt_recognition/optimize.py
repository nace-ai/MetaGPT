...
from metagpt.receipt_recognition.optimizer import Optimizer
...
EXPERIMENT_CONFIGS: Dict[str, ExperimentConfig] = {
    "ReceiptRecognition": ExperimentConfig(
        dataset="ReceiptRecognition",
        question_type="Vision Understanding",
        operators=["Custom", "DocumentInlining", "PDFSummary", "PDFPageExtraction", "ReceiptRecognitionResultFormatting", "ScEnsemble", "JSONExtraction"],
    ),
}


def parse_args():
    parser = argparse.ArgumentParser(description="Receipt Recognition Optimizer")
    parser.add_argument(
        "--dataset",
        type=str,
    ...
    parser.add_argument(
        "--optimized_path",
        type=str,
        default="metagpt/receipt_recognition/optimized",
