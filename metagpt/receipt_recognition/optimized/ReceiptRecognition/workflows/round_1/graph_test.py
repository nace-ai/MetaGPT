...
class Workflow:
    def __init__(
        ...
        name: str,
        llm_config,
        dataset: DatasetType = "ReceiptRecognition",
    ) -> None:
        self.name = name
...
async def test_workflow():
    ...
    test_workflow = Workflow(name="ReceiptRecognition", llm_config=llm_config)
    file_path = "/Users/zhengwang/Documents/projects/MetaGPT/metagpt/receipt_recognition/Dominic_Miceli_R00G6o7yOemJ_2023_09_26.pdf"
    result, cost = await test_workflow(file_path)
    print(result, cost)
